...
const PoolPage = observer(() => {
  ...
  useEffect(() => {
    if (!poolStore.searchKey) {
      poolStore.getList().then()
      return;
    }
  ...
  }, [poolStore.searchKey, poolStore.page, poolStore.size]);
    ...
    <div className="flex flex-col gap-6">
      ...
      <Card className="border-border shadow-sm">
        ...
        <CardContent>
            ...
            <Fragment>
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody>
                  {(poolStore.lists || []).map((item, index) => (
                    <tr
                      key={index}
                      className=""
                    >
                      ...
                      <td>
                        <div className="flex items-center gap-2">
                          <Button
                            ...
                            loading={poolStore.isLoadingGet}
          ...
          <CustomPagination
            currentPage={poolStore.page}
            totalPages={poolStore.totalPages}
            onChangePage={handlePage}
            currentSize={poolStore.size}
