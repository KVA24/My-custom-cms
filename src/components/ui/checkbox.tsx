...
const checkboxVariants = cva(
  `
    ...
    in-data-[invalid=true]:border-destructive/60 in-data-[invalid=true]:ring-destructive/10  dark:in-data-[invalid=true]:border-destructive dark:[[data-invalid=true]_&]:ring-destructive/20,
