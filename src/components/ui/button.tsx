  ...
  'cursor-pointer group whitespace-nowrap focus-visible:outline-hidden inline-flex items-center justify-center has-data-[arrow=true]:justify-between whitespace-nowrap text-sm font-medium ring-offset-background transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-60 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        warning:
          'bg-yellow-500 text-primary-foreground hover:bg-yellow-500/90 data-[state=open]:bg-yellow-500/90',
        error:
          'bg-red-500 text-primary-foreground hover:bg-red-500/90 data-[state=open]:bg-red-500/90',
        danger:
          'bg-red-500 text-primary-foreground hover:bg-red-500/90 data-[state=open]:bg-red-500/90',
        info:
          'bg-purple-500 text-primary-foreground hover:bg-purple-500/90 data-[state=open]:bg-purple-500/90',
      ...
      size: {
        ...
        md: 'h-8 rounded-md px-3 gap-1.5 text-[0.8125rem] leading-(--text-sm--line-height) [&_svg:not([class*=size-])]:size-4',
    ...
    compoundVariants: [
      ...
      },
      {
        size: 'md',
        mode: 'icon',
        className: 'w-8.5 h-8 p-0 [&_svg:not([class*=size-])]:size-4',
      },
      {
        size: 'icon',
        className: 'w-8.5 h-8 p-0 [&_svg:not([class*=size-])]:size-4',
...
function Button({
  ...
  return (
    ...
    >
      ...
      <span className={cn("flex gap-1 items-center", loading && 'hidden')}>{children}</span>
    </Comp>
    // <Comp
    //   data-slot="button"
    //   className={cn(
