...
const DialogHeader = ({className, ...props}: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    ...
    className={cn('flex flex-col gap-1 text-center sm:text-start mb-5', className)}
    {...props}
  />
);
...
const DialogFooter = ({className, ...props}: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    ...
    className={cn('flex flex-col-reverse sm:flex-row sm:justify-end pt-5 sm:gap-2.5', className)}
    {...props}
  />
);
